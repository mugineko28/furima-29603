...
ActiveRecord::Schema.define(version: 2021_02_18_053036) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_information_id"], name: "index_addresses_on_purchase_information_id"
  end
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "prefecture_id", null: false
    t.integer "day_to_skip_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "addresses", "purchase_informations"
